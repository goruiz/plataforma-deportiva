...
public interface MatchMapper {
    ...
    MatchesEntity toEntity(CreateMatchRequest request);
    ...
    @Mapping(target = "deletedBy", ignore = true)
    @Mapping(target = "deletedAt", ignore = true)
    void updateEntity(@MappingTarget MatchesEntity entity, UpdateMatchRequest request);

    MatchResponse toResponse(MatchesEntity entity);
}
